...
btn_clear = tk.Button(root, text="C", command=clear_field(), width=10, font=("Aerial", 14))
btn_clear.grid(row=6, column=1, columnspan=2)
btn_equals = tk.Button(root, text="=", command=evaluate_calculation, width=10, font=("Aerial", 14))
